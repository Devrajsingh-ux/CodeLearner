...
export function Stats() {
  return (
    <section className="py-12 sm:py-16 lg:py-20" aria-label="Platform statistics">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl border border-white/8 bg-gradient-to-br from-violet-600/10 via-zinc-900 to-indigo-600/10 p-px">
